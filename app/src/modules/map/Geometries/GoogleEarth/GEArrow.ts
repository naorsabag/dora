...
export class GEArrow extends Arrow {
	...
	protected setLineColor(color: string): void {
		let colorObj = (<any>this.geometryOnMap.getStyleSelector()).getLineStyle().getColor();
	...
	protected setLineWidth(width: number): void {
		(<any>this.geometryOnMap.getStyleSelector()).getLineStyle().setWidth(width);
	}

	protected setFillColor(color: string): void {
		let colorObj = (<any>this.geometryOnMap.getStyleSelector()).getPolyStyle().getColor();
		this.geMapComponent.utils.setColor(colorObj, color);
	}
