...
export class VerticalStripedFillPattern extends FillPattern {
	...
	public applyToGeometry(geometry: IGeometryWithFillPattern, polygonGeoJsonFeature: GeoJSON.Feature<GeoJSON.Polygon>): void {
		...
		const stripesCoordinates = FillPatternUtils.generateStripes(this.numberOfStripes, polygonGeoJsonFeature, PatternDirection.S_TO_N);
